...
-- TABLE ORDERS
ALTER TABLE ORDERS DROP CONSTRAINT FK_ORDERS_DELIVERY_SERVICE
...
INSERT INTO ORDERS VALUES (GETDATE(),1,30,1,30,N'KHÔNG CÓ NOTE',NULL,NULL,N'163',N'HCM',N'VIET NAM',N'094')
